              ...
              <div className="bg-gradient-to-br from-ink-900 to-ink-800 rounded-2xl p-6 text-cream-50">
                ...
                <form className="space-y-3">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-ink-700 border border-ink-600 rounded-xl text-cream-100 placeholder:text-ink-400 focus:outline-none focus:border-accent-gold text-body-sm"
                  />
